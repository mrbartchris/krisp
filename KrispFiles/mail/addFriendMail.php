...
$mail->Subject = 'Friend Request';							//Set the subject line
...
<div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 20px;">
  <h1>Someone sent you a friend request!</h1>
  <div align="center">
    <a href="localhost/KrispFiles/addFriend?frec='.$emailF.'&fsend='.$email.'">Add '.$usern.' to your friends list!</a>
  </div>
