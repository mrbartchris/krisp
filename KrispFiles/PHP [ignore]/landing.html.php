	...
	<div class="container-fluid headPadTop">
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
					...
					<div class="textC row">
						...
						<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
							<a href="landingGames.html.php">
								<button type="button" class="btn btn-primary btn-block">
									<img src="imgs/connect4.png" class="img-circle border-radius-500px" alt="Connect 4 icon" >
									</img>
								</button>
							</a>
							<b>Connect 4</b>
						...
						<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
							<a href="">
								<button type="button" class="btn btn-primary btn-block">
									<img src="imgs/uno.png" class="img-circle border-radius-500px" alt="Uno icon" >
									</img>
								</button>
							</a>
							<b>Uno</b>
						...
						<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
							<a href="">
								<button type="button" class="btn btn-primary btn-block">
									<img src="imgs/ship.png" class="img-circle" alt="Battle ships icon" >
									</img>
								</button>
							</a>
							<b>Battle Ships</b>
						...
						<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
							<a href="">
								<button type="button" class="btn btn-primary btn-block">
									<img src="imgs/snake.jpg" class="img-circle" alt="Snakes and Ladders icon" >
									</img>
								</button>
							</a>
				...
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
					<iframe src="http://localhost:3000" height="300px">
